...
import type { MappedCharacter, SpacingMode, WritingMode } from '../types'
 ...
 */
export function TypeBlock({ item, animationIndex, writingMode, spacing = 'default', onReplace }: TypeBlockProps) {
